const fizzBuzzFunc = require('./index');

test('fizzBuzzFunc function is defined', () => {
  expect(fizzBuzzFunc).toBeDefined();
});

test('Calling fizzBuzzFunc with `5` prints out 5 statements', () => {
  fizzBuzzFunc(5);
  expect(console.log.mock.calls.length).toEqual(5);
});

test('Calling fizzBuzzFunc with 15 prints out the correct values', () => {
  fizzBuzzFunc(15);
